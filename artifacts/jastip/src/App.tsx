...
function Router() {
  return (
    <Switch>
      ...
      {/* Customer Routes */}
      <Route path="/customer/dashboard">{(params) => <ProtectedRoute role="customer" component={CustomerDashboard} params={params} />}</Route>
      <Route path="/customer/packages">{(params) => <ProtectedRoute role="customer" component={CustomerPackages} params={params} />}</Route>
      <Route path="/customer/scan">{(params) => <ProtectedRoute role="customer" component={CustomerScan} params={params} />}</Route>
      <Route path="/customer/history">{(params) => <ProtectedRoute role="customer" component={CustomerHistory} params={params} />}</Route>

      {/* Admin Routes */}
      <Route path="/admin/dashboard">{(params) => <ProtectedRoute role="admin" component={AdminDashboard} params={params} />}</Route>
      <Route path="/admin/packages">{(params) => <ProtectedRoute role="admin" component={AdminPackages} params={params} />}</Route>
      ...
      <Route path="/owner/packages">{(params) => <ProtectedRoute role="owner" component={OwnerPackages} params={params} />}</Route>
      <Route path="/owner/customers">{(params) => <ProtectedRoute role="owner" component={OwnerCustomers} params={params} />}</Route>
