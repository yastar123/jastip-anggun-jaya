...
export default function Register() {
  ...
  async function onSubmit(values: z.infer<typeof registerSchema>) {
    try {
      ...
      toast({ variant: "destructive", title: "Registrasi gagal", description: error.message || "Terjadi kesalahan saat mendaftar" });
    } finally {
      ...
      <div className="w-full lg:w-1/2 xl:w-2/5 flex flex-col items-center justify-center bg-white px-6 py-12 overflow-y-auto">
        ...
        <div className="w-full max-w-sm">
          <div className="mb-7">
            ...
            <p className="text-muted-foreground mt-1 text-sm">Daftar sekarang dan mulai gunakan layanan kami</p>
          </div>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Nama sesuai KTP" className="h-11" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
